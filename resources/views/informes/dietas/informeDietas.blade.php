                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row" id="row">
                                    ...
                                    <div class="chart-area col-lg-6" id="piechart2"></div>
                                    <div class="col-lg-6">
                                        <div class="col-lg-12 m-auto py-1">
                                            <div class="row">
                                                <div class="col-md-6 mt-3 pr-5">
                                                    <a class="btn btn-info" href="{{ route('informe-dietas.create') }}">
                                                        Ver Pacientes
                                                    </a>
                                                </div>
                                                <form action="{{ route('informe-dietas.verPdf') }}" id="form_ver_pdf" method="post" target="_blank">
                                                        @csrf
                                                        <div class="form-group">
                                                         ...
                                                         <select class="mt-2 form-control form-control-user" name="prueba" required="" id="destinatario1">
                                                            <option disabled="" selected="">
                                                                Seleccione a quien le envia
                                                            </option>
                                                            @foreach($empleadosEnviar as $empleado)
                                            ...
                                            <form action="{{ route('informe-dietas.enviarPdf') }}" id="make_pdf" method="post">
                                                @csrf
                                                <div class="form-group">
                            ...
                            <div  class="chart-area col-lg-6" id="piechart"></div>
                            <!-- CAR-BODY-->
                        </div>
                        <!-- CARD -->
                    </div>
