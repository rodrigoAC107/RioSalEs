...
<script type="text/javascript">
    google.charts.load('current', {'packages':['corechart']});
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Grafica de Grupo Sanguineo',
                                        ...
                                        <div class="col-lg-12 m-auto py-1">
                                            <div class="row">
                                                <div class="col-md-6 mt-3 pr-5">
                                                    <a class="btn btn-info" href="{{ route('informe-donacion.create') }}">
                                                        Ver Pacientes
                                                    </a>
                                                </div>
                                                <form action="{{ route('informe.verPdf') }}" id="form_ver_pdf" method="post" target="_blank">
                                                    @csrf
                                            ...
                                            <form action="{{ route('informe.pdfDonacion') }}" id="make_pdf" method="post">
                                                @csrf
                                                <div class="form-group">
