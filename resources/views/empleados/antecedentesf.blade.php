        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Agregar Antecendetes Familiares del Paciente</h1>
              </div>
            ...
            <div class="justify-content-center text-center text-uppercase py-1 d-none d-xl-block d-lg-block" style="font-size: x-large;font-size: 2vw">
              ...
              <form class="user" method="POST" action="{{route('antecedenteFamiliar.store')}}" aria-label="{{ __('Antecedentes Familiares') }}" autocomplete="off">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-3 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user{{ $errors->has('tipo') ? ' is-invalid' : '' }}" name="tipo" value="{{ old('tipo') }}" id="exampleLastName" placeholder="Tipo de Antecedente">
                    @if ($errors->has('tipo'))
                                    <span class="invalid-feedback" role="alert">
