        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Agregar Informacion sobre Habitos</h1>
              </div>
            ...
            <div class="justify-content-center text-center text-uppercase py-1 d-none d-xl-block d-lg-block" style="font-size: x-large;font-size: 2vw">
              ...
              <form class="user" method="POST" action="{{route('habitos.store')}}" aria-label="{{ __('Informacion de Habitos') }}" autocomplete="off">
